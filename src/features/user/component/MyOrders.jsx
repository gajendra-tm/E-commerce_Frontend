    ...
    <>
      <div>
        {userOrders.map((order) => (
          <div
            key={order.id}
            className="flex flex-col justify-center items-center pt-5 max-w-full min-h-full"
          >
            <div className="p-4 w-full sm:w-9/12 bg-gray-100 rounded-md">
              ...
              <h3 className="flex justify-between text-pink-500 text-base font-medium tracking-wide">
                <span>
                  Order status :{" "}
                  <span
                    className={`${
              ...
              <div className="border-t-2 border-gray-300 mb-2 py-5 ">
                ...
                <div className="p-2 mb-1 border-2 border-gray-300">
